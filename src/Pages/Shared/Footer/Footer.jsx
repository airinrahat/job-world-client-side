  ...
  return (
    <div className="p-10 bg-base-200 text-base-content ">
      <footer className="footer pb-5 mx-auto max-w-screen-xl">
        <aside>
          <nav className="text-[#18ad50] font-bold text-4xl">Abut Jobworld</nav>
      ...
      {/* <div className="bg-base-200">
        <footer className="footer px-10 py-4 border-t  text-base-content border-base-300 mx-auto max-w-screen-xl">
